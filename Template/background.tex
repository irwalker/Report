...
%Discussion of this reputation stuff.
...
%E.g. sentiment analysis of Tweets shown to predict stock market trends.
...
Proposed solutions have suggested approaches such as promoting competition between webservices, using an independant entity to evaluate the different web services against given criteria. %More discussion... Can't think right now!
